...
/* ============================================================
   7. СПЛЭШ-ЭКРАН (только мобильные)
   ============================================================

   Появляется при первом открытии сайта на мобильном.
   Показывается 1 раз за сессию (sessionStorage).
   Анимация: логотип + заголовок → fade out.
   ============================================================ */
...
function initSplash() {
  ...
  if (sessionStorage.getItem('gop-splash-shown')) return;
  sessionStorage.setItem('gop-splash-shown', '1');
  ...
  splash.innerHTML = `
    <div class="splash-inner">
      <div class="splash-logo">
        <svg viewBox="0 0 60 80" width="60" height="80" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <!-- Крышка бака -->
          <rect x="8" y="14" width="44" height="5" rx="1" stroke="#f5f2ed" stroke-width="1.5"/>
          <!-- Ручка крышки -->
          <rect x="26" y="8" width="8" height="7" rx="1" stroke="#f5f2ed" stroke-width="1.5"/>
          <!-- Тело бака -->
          <path d="M13 19 L16 72 Q16 74 18 74 L42 74 Q44 74 44 72 L47 19 Z" stroke="#f5f2ed" stroke-width="1.5" stroke-linejoin="round"/>
          <!-- Вертикальные линии (секции бака) -->
          <line x1="24" y1="22" x2="22" y2="71" stroke="#f5f2ed" stroke-width="1" opacity="0.45"/>
          <line x1="36" y1="22" x2="38" y2="71" stroke="#f5f2ed" stroke-width="1" opacity="0.45"/>
          <!-- Горизонтальная полоса -->
          <line x1="14.5" y1="42" x2="45.5" y2="42" stroke="#f5f2ed" stroke-width="1" opacity="0.3"/>
        </svg>
      </div>
      <div class="splash-title">
        <span class="splash-word">Garbage</span>
        <span class="splash-word">of Paris</span>
      </div>
      <div class="splash-sub">Visual sociology</div>
    </div>
  `;
  ...
  // Анимация появления элементов через CSS-классы с задержками
